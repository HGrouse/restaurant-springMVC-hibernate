...
public final class ConnectionPool {
    ...
    private void initPoolData() throws ConnectionPoolException {
        try {
            ...
            driverName = dbResourceManager.getValue(DBParameter.DRIVER_NAME);
            url = dbResourceManager.getValue(DBParameter.DB_URL);
            login = dbResourceManager.getValue(DBParameter.USERNAME);
            ...
            log.debug(getClass().getName() + " || driverName = " + driverName);
            log.debug(getClass().getName() + " || poolSize = " + poolSize);
    ...
    public Connection takeConnection() {
        ...
        try {
            log.debug(getClass().getName() + " || inUseConnectionQueue size is " + inUseConnectionQueue.size());
            log.debug(getClass().getName() + " || connectionQueue size is " + connectionQueue.size());
